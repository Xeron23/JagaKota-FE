    ...
    <div className="min-h-screen flex flex-col bg-[#FFFFFF] text-gray-800">
      ...
      <main className="flex-grow overflow-y-auto">
        <div className="w-full flex flex-wrap h-[561px] bg-[#F7EEDF]">
          ...
          {/* Right Side */}
          <div className="w-full md:w-[calc(40%-25px)] bg-[url('/images/Rectangle17.svg')] flex flex-col justify-start p-10 space-y-6 h-[561px]">
          ...
          {[...Array(8)].map((_, i) => (
            ...
            >
              ...
              <div className="bg-white w-[331px] h-[282px] rounded text-black font-semibold overflow-hidden shadow-md shadow-gray-400/50 shadow-b ">
                ...
                {/* Text */}
                <div className="p-3">
                  <h3 className="text-sm font-bold">Pengecoran di Jalan Pangeran</h3>
                  <p className="text-xs font-normal text-gray-600">
                    Terjadi bolongan di Jalan Pangeran yang menimbulkan kecelakaan...
                  </p>
                </div>
              </div>
              </a>
      ...
      <div className="flex w-full h-[421px]  overflow-hidden">
        {/* Gambar */}
        <div 
          className="w-[893px] h-full"
        >
          <img src="/images/Intersect.png" alt="Intersect" className="w-full h-full object-cover block" />
        </div>
      ...
      <div className="h-[190px] w-[1115px] bg-[#F7EEDF] mx-auto mb-[50px] mt-[70px] rounded-xl flex items-center justify-around text-center">
        ...
        <div className="flex-1">
          ...
          <p className="text-[15px]">Penghargaan Pengabdian<br/>Masyarakat dari Wali Kota</p>
        </div>
      </div>


      <div className="h-[551px] w-full mx-auto mt-[50px] bg-[#DEBC7D] flex items-center justify-end pr-[50px] bg-no-repeat"
        style={{ 
