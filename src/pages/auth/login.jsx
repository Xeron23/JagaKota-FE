          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col items-center gap-2 mt-6 p-4">
              <ButtonSubmit 
                ...
                <a href="/" className="h-[42px] flex items-center justify-center w-[312px] bg-white border border-[#6B8F71] text-[#6B8F71] py-2 px-4 rounded-md transition-colors duration-200">
                    Daftar
                </a>
            </div>
