...
import { getAllProvince, getRegencyById, uploadLaporan } from '../resolver/auth/province';
...
const UploadForm = () => {
    ...
    return (
        ...
        style={{
            backgroundImage: "url('/images/laporan.png'), linear-gradient(#F7EEDF, #F7EEDF)",
        ...
        <div className="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow-md mt-10">
            <h2 className="text-2xl font-bold mb-6 text-center">Upload Data Lokasi</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="province" className="text-gray-700 font-medium mb-1">Provinsi</label>
                            <select
                                id="province"
                                name="province"
                    ...
                    <div className="flex flex-col items-center border rounded-lg p-4 bg-gray-50">
                        ...
                        <div className="mt-4 w-full">
                            <label htmlFor="photo" className="block text-sm font-medium text-gray-700 mb-1">Foto Lokasi *</label>
                            <input
                                type="file"
                                id="photo"
                                name="photo"
                ...
                <div className="flex justify-center">
                    <label className="flex items-start gap-2 max-w-2xl text-center">
                        ...
                        <span>
                            ...
                            kirimkan dan segala informasi yang tercantum adalah benar adanya.
                        </span>
                    </label>
                </div>
